...
export default function EditPassword() {
  ...
  const handleSubmit = async (event) => {
    ...
    const enteredOldPassword = data.get("old_password");
    const enteredNewPassword = data.get("new_password");
    const enteredConfirmPassword = data.get("confirm_password");

    // Assuming you have the actual old password stored somewhere
    const actualOldPassword = "exampleOldPassword"; // Replace this with the actual old password
    ...
    if (enteredOldPassword !== actualOldPassword) {
