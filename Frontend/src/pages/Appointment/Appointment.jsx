  ...
  return (
    <div style={{ marginBottom: "20px" }}>
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-around", flexWrap: "wrap", marginTop: "20px", color: "black" }}>
          {schedule.map((sch, dayIndex) => (
            <div key={dayIndex} style={{ display: "flex", flexDirection: "column", alignItems: "center", margin: "20px", minWidth: "200px", color: "black" }}>
              <Card key={dayIndex} style={{ display: "flex", flexDirection: "column", alignItems: "center", margin: "10px", padding: "10px", minWidth: "200px", height: "250px", border: "1px solid #ddd", borderRadius: "20px", color: "black" }}>
                <CardContent>
                  <Typography variant="h6" gutterBottom>
                    {sch.day}
                  </Typography>
                  <div className="select__wrapper">
                    <label htmlFor={`appointment-${dayIndex}`} style={{ marginRight: "10px" }}>
                      Add/Edit Appointment
                    </label>
                    <input type="text" id={`appointment-${dayIndex}`} />

                    <div className="select__wrapper" style={{ marginTop: "10px" }}>
                      <label htmlFor={`startTime-${dayIndex}`} style={{ marginRight: "30px" }}>
                        Add/Edit Start Time
                      </label>
                    ...
                    <div className="select__wrapper" style={{ marginTop: "10px" }}>
                      <label htmlFor={`endTime-${dayIndex}`} style={{ marginRight: "35px" }}>
                        Add/Edit End Time
                      </label>
                    ...
                    <button
                      onClick={() => {
                        const appointmentName = document.getElementById(`appointment-${dayIndex}`).value;
                        ...
                        if (appointmentName && startTime && endTime) {
                          handleAddAppointment(dayIndex, appointmentName, startTime, endTime);
                          document.getElementById(`table-${dayIndex}`).style.display = "table";
                        }
                      }}
              ...
              <TableContainer style={{ display: "none" }} id={`table-${dayIndex}`}>
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <Link to="/calendarpage">
                        <Button onClick={() => handleSaveButtonClick(dayIndex)} style={{ color: "black", border: "1px solid black", padding: "2px" }}>
                          Save
                        </Button>
                        </Link>
                      </TableCell>
                  ...
                  <TableBody>
                    {sch.appointments.map((appointment, appIndex) => (
                      <TableRow key={appIndex}>
                        ...
                        <TableCell style={{ borderBottom: "1px solid black" }}>
                          <Button onClick={() => handleEditAppointment(dayIndex, appIndex)}>Edit</Button>
                          <Button onClick={() => handleDeleteAppointment(dayIndex, appIndex)}>Delete</Button>
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
